package com.coding.leetcode.concurrency.diningphilosophers1226;
...
public class DiningPhilosophers {
    ...
    public void wantsToEat(int philosopher,
        ...
        int chop1 = philosopher;
        int chop2 = (philosopher + 1) % 5;
        chopSticks[Math.min(chop1, chop2)].lock();
        chopSticks[Math.max(chop1, chop2)].lock();
        pickLeftFork.run();
        pickRightFork.run();
        eat.run();
        putLeftFork.run();
        putRightFork.run();
        chopSticks[Math.min(chop1, chop2)].unlock();
        chopSticks[Math.max(chop1, chop2)].unlock();
    }
